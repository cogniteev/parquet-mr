...
public class ParquetProperties {
  ...
  public static final boolean DEFAULT_IS_STATISTICS_ENABLED = true;
  ...
  public static class Builder {
    ...
    private Builder() {
      ...
      enableStatistics = ColumnProperty.<Boolean>builder().withDefaultValue(DEFAULT_IS_STATISTICS_ENABLED);
