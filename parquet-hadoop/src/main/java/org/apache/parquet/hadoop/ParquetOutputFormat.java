...
import static org.apache.parquet.column.ParquetProperties.DEFAULT_IS_STATISTICS_ENABLED;
...
public class ParquetOutputFormat<T> extends FileOutputFormat<Void, T> {
  ...
  public static boolean getStatisticsEnabled(Configuration conf) {
    return conf.getBoolean(STATISTICS_ENABLED, DEFAULT_IS_STATISTICS_ENABLED);
  }
